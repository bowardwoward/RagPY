...
st.set_page_config(page_title="WENDALE BAYOT", page_icon=":robot_face:")


def display_messages():
    """Display the chat history."""
    st.subheader("Chat History")
    image_avatar = "https://media1.tenor.com/m/WP2NxV9cUYUAAAAC/shelf.gif"
    for i, (msg, is_user) in enumerate(st.session_state["messages"]):
        if is_user:
            image_avatar = "https://avatars.githubusercontent.com/u/195722908?s=400&u=3d1369a4330e834df0d22d0216259d5270d105ee&v=4"
        else:
            image_avatar = "https://media1.tenor.com/m/WP2NxV9cUYUAAAAC/shelf.gif"
        message(msg, is_user=is_user, key=str(i), logo=image_avatar)
...
def page():
    ...
    st.header("BSP RAG JAK ROBERTO AI v3 build 69 420")
