...
CTRs/ STRs of BSFls to Total CTRs/STRs Received by the AMLC (Number and %)
...
3.2.5.3. Comprehensive AML Legal Framework — High. No. 8367, otherwise known as the Revised NSSLA Act of 1997, the BSP was granted the power to enforce the laws, orders, instructions, rules and regulations approved by the MB applicable to NSSLAs. Accordingly, NSSLAs are considered CPs under the AMLA, as amended.
...
system used by participants ee ‘ie anna omega ' ettlement , ettlement of an ACH. It provides (Debit DDA of OFI) sits gi (Credit DDA of RFI) ” © clearing infrastructure for an 1 Multiple settlement ACH and i) performs netting + mmo . Debit account of Payor Say, of payment instructions pone a . Forward payment j Route message to received from participating instruction fo ACH Receiving Fl { A in stitution Ss; ii) fo rwa rd sn et Issue payment instruction to r Credit account Originating Fl of Payee
...
Merchant Figure 20. Merchant Acquirer acquiring is the process through which merchants can accept
...
Ph Total Merchandise Trade (in PHP
...
Philippines, which ranked 39th 2 Ms Total PH Imports mmm Total PH Exports 93 (from 52nd), is one of the Ke z . ’ Sz Total a countries which rose the most =O = 8,000.00 10,000.00 = in world rankings for 2° 20 w . IE aaa = merchandise trade over the 5 = 4,000.00 5,000.00 x

past ten years (2009 to 2019) = 2,000.00 I I I I I I I zm . Main imports 2009 2011 2013 2015 2017 2019 e
...
There was no trade of potentially strategic goods with DPRK for the period January 2018 to August 2020. On the other hand, Iran has an aggregate USD2.38 million?® import and export transactions which account for 0.0004 percent of the total merchandise trade of the Philippines. The past UN trade restrictions imposed on Iran led to a decline in Philippine trade transactions with Iran, particularly on banana shipments to that country*.
...
100 Department of Economic Statistics, BSP. Transactions from 2017 up to February 2020.
...
PF threat to BSFls is ow due to minimal transactions/connections with DPRK and Iran, and minimal import and export of DUGs. TBPF threat has been on a decreasing trend from 2017 up to 31 August 2020. There were no trade of potentially strategic goods with DPRK from January 2018 to August 2020.
...
: : 196 200 2.0% and medium enterprises.
...
1033 streamlines the process of securing licenses to engage in electronic payments and financial services

1049 requires the registration of operators of payment systems;

1055 promotes the adoption of a National Quick Response Code Standard

R.A. No. 11055 establishes the “PhilSys” as a national digital ID to promote financial inclusion

1022 on AML/CFT regulations provides, among others, the use of PhilSys ID card as an official document for financial transactions and technology for CDD requirements

Others

940 allows banks to contract retail outlets as cash agents where clients can avail banking services Circular No. 987 provides guidelines in establishing branch- lite units through affordable licensing fees to entice banks to expand access points to serve MF clients

992 outlines the BDA framework which aims to liberalize customer onboarding and to increase access of the unserved and underserved to financial services
...
Use of Banks by NPOs in the facilitation of TF
